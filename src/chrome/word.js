...
const close_button_style =
  "background-color: #4d4d4d; border-radius: 2px; color: #64b5f6; border: none; cursor: pointer; margin-left: 12px; font-size: inherit; font-family: Google Sans,Roboto,sans-serif;";
